...
interface ValidationErrorModalProps {
  isOpen: boolean;
  onClose: () => void;
  errorType: "date_past" | "date_reversed" | "date_too_long" | "budget_negative" | "budget_unrealistic" | "budget_overflow" | "members_exceeded" | "invalid_destination";
}
...
const ERROR_CONFIGS = {
  ...
  date_too_long: {
    ...
    description: "Trip duration cannot exceed 1 year. For longer trips, consider creating multiple trips.",
  ...
  members_exceeded: {
    ...
    description: "Free plan supports up to 6 members per trip. Upgrade to Pro for unlimited members.",
  ...
  invalid_destination: {
    ...
    description: "We couldn't find this destination. Please enter a valid city, country, or landmark.",
    iconColor: "text-red-500",
