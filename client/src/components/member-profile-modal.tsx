...
export function MemberProfileModal({
  ...
  const participationScore = Math.min(
    ((member.stats.commentsPosted * 10 +
      member.stats.votesParticipated * 5 +
      member.stats.activitiesAdded * 15) /
      100) *
      100,
    100
  );
            ...
            <div className="grid grid-cols-2 gap-3">
              <Card className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {member.stats.expensesPaid}{' '}
                  {member.stats.expensesPaid === 1 ? 'expense' : 'expenses'}
                </p>
              </Card>
              ...
              <Card className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">For shared expenses</p>
              </Card>
                ...
                <p className="text-3xl font-bold">
                  {member.stats.netBalance === 0 ? (
                    ...
                    <span className="text-green-600">
                      +{formatCurrency(member.stats.netBalance)}
                    </span>
                  ) : (
