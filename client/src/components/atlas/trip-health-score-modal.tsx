          ...
          <Card className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 border-blue-200">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{daysUntilTrip} days until trip</p>
              </div>
            ...
            <Card className="p-3 bg-white/50">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm">
                  {overallScore >= 80 &&
                    'Your trip is in great shape! Keep up the excellent planning.'}
                  {overallScore >= 60 &&
                    overallScore < 80 &&
                    "You're on the right track. Address a few items to improve your score."}
                  {overallScore >= 40 &&
                    overallScore < 60 &&
                    'Your trip needs some attention. Focus on the areas highlighted below.'}
                  {overallScore < 40 &&
                    "Several areas need immediate attention. Let's get your trip back on track!"}
                </p>
              </div>
            </Card>
          </Card>
                  ...
                  <Card key={index} className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div
                          className={`flex h-10 w-10 items-center justify-center rounded-lg ${statusConfig.bgColor}`}
                        >
          ...
          <Card className="p-3 bg-blue-50 border-blue-200">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-blue-900">
                <strong>Atlas Insight:</strong> I'll keep monitoring your trip health and send
                proactive alerts when things need attention. Check back regularly to maintain a high
                score!
              </p>
            </div>
          </Card>
