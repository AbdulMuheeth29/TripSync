  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className={`mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br ${getUrgencyColor()}`}>
          ...
          <DialogDescription className="text-center">
            <strong>{tripName}</strong> starts in {daysUntilTrip} {daysUntilTrip === 1 ? "day" : "days"}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-blue-800">
                {completionPercentage === 100 ? (
                  ...
                  <span>
                    <strong>Time is running out!</strong> Focus on completing high-priority tasks before your trip.
                  </span>
                ) : isUrgent ? (
                  <span>
                    <strong>Don't wait!</strong> Complete pending tasks soon to ensure a smooth trip.
                  </span>
                ) : (
                  <span>
        ...
        <DialogFooter className="flex-col gap-2">
          ...
          <Button onClick={onClose} variant={completionPercentage === 100 ? "default" : "outline"} className="w-full">
