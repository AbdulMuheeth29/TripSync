...
export function FailedPaymentBanner({
  ...
  return (
    <Card className={`p-0 overflow-hidden border-2 ${
      ...
      isUrgent ? 'border-amber-500 bg-amber-50' :
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4 mb-2">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {isUrgent && !isCritical && (
                    <Badge className="bg-amber-500 uppercase text-xs">
                      Urgent
                    </Badge>
                  )}
                </div>
            ...
            {daysUntilSuspension > 0 && (
              <Alert className={`mb-4 ${
                ...
                isUrgent ? 'bg-amber-100 border-amber-300' :
                ...
                <AlertDescription className={`text-sm ${
                  ...
                  <strong>
                    {daysUntilSuspension === 1
                      ? 'Final day'
                      : `${daysUntilSuspension} days left`}
                  </strong>{' '}
                  to update your payment before your account is suspended and you lose access to premium features.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                className={
                  ...
                  isUrgent ? 'bg-amber-600 hover:bg-amber-700' :
                  ''
                }
              >
            ...
            <p className={`text-xs mt-3 ${
              ...
              <strong>Need help?</strong> Contact our support team at support@tripsync.com or
