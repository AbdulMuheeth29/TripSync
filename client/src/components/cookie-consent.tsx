...
function saveConsent(analytics: boolean, preferences: boolean) {
  ...
  try {
    ...
    window.dispatchEvent(
      new CustomEvent("tripsync-cookie-consent", { detail: payload })
    );
  } catch {
          ...
          <div className="rounded-2xl border bg-background/95 backdrop-blur shadow-lg p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-1 text-sm">
              ...
              <p className="text-muted-foreground">
                We use cookies to provide essential functionality and improve your experience. Strictly necessary
                cookies are always active. You can customize optional cookies below. See our{" "}
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose which optional cookies you want to allow. Strictly necessary cookies are always active because
              they&apos;re required for TripSync to function securely.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-2">
            <div className="flex items-start justify-between gap-4 rounded-lg border bg-muted/60 px-3 py-2.5">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Required for TripSync to work securely, including authentication, session management, and CSRF
                  protection. These cookies are always on.
                </p>
              </div>
            ...
            <div className="flex items-start justify-between gap-4 rounded-lg border px-3 py-2.5">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Helps us understand how TripSync is used so we can fix issues and improve features. Analytics data
                  is aggregated and not used to show you ads.
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-start justify-between gap-4 rounded-lg border px-3 py-2.5">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Stores your theme, language, and other settings so we can remember your preferences between
                  visits.
                </p>
              </div>
              <Switch
