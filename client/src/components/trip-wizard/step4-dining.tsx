...
const DINING_OPTIONS: Array<{
...
}> = [
  {
    ...
    examples: ["Michelin-starred restaurants", "Tasting menus", "Wine pairings", "Celebrity chef venues"],
    priceRange: "$$$-$$$$"
  },
  {
    id: "casual",
  ...
  },
  {
    ...
    examples: ["Fine dining for special nights", "Street food for lunch", "Local restaurants", "Variety of experiences"],
    priceRange: "$$-$$$"
  }
];
      ...
      {selectedType && (
        <div className="rounded-lg border border-primary/50 bg-primary/5 p-4">
          <p className="text-sm text-primary">
            ✨ We'll include {selectedType === "mix" ? "a variety of dining experiences" : DINING_OPTIONS.find(o => o.id === selectedType)?.name.toLowerCase() + " options"} in your itinerary.
          </p>
        </div>
      )}
