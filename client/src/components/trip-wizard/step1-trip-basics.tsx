  ...
  return (
    <form onSubmit={handleSubmit(onNext)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        />
        {errors.tripName && <p className="text-sm text-red-500">{errors.tripName.message}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">Try: "Bali, Indonesia" or "Paris, France"</p>
      </div>
