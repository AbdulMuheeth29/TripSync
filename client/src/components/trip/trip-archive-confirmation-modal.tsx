    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Archive "{trip.name}" from your active trips
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {trip.hasUnsettledExpenses && (
            <Alert variant="destructive">
              ...
              <AlertDescription className="text-sm">
                <strong>Warning:</strong> This trip has {formatCurrency(trip.totalUnsettled)} in unsettled expenses.
                Members will still be able to view and settle these after archiving.
              </AlertDescription>
            </Alert>
          )}
          ...
          <Card className="p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
                <p className="text-muted-foreground">Members can still settle outstanding expenses</p>
              </div>
              <div className="flex items-start gap-2">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-900">
              <strong>Note:</strong> You can unarchive this trip later from the Archived section if needed.
            </p>
          </div>
        </div>
