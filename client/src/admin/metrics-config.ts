...
export const PHASE1_MVP: MetricSection = {
  ...
  metrics: [
    ...
    { id: 'votes-per-item', label: 'Votes per itinerary item', description: 'Group Voting' },
    {
      ...
      description: 'Booking Coordination',
      format: 'percent',
      defaultOn: true,
    },
    { id: 'expenses-per-trip', label: 'Expenses logged per trip', description: 'Expense Logging' },
    {
      id: 'calendar-sync-pct',
      label: '% of trips synced to calendar',
    ...
    {
      id: 'push-action-rate',
      label: 'Push notification action rate',
      description: 'Push Notifications',
      format: 'percent',
    },
  ],
...
export const PHASE2_COMPETITIVE: MetricSection = {
  ...
  metrics: [
    {
      id: 'flight-alert-accuracy',
      label: 'Alert accuracy',
      description: 'Flight Status Monitoring',
      format: 'percent',
    },
    {
      id: 'flight-alert-response',
      label: 'User response rate',
      description: 'Flight Status Monitoring',
      format: 'percent',
    },
    {
      id: 'alt-rec-ctr',
      label: 'Click-through rate on alternatives',
      description: 'Alternative Recommendations',
      format: 'percent',
    },
    {
      id: 'price-drop-pct',
      label: '% of price drops caught',
    ...
    {
      id: 'mention-response-time',
      label: 'Mention response time',
      description: '@Mentions in Chat',
      format: 'time',
    },
    {
      id: 'availability-time-reduction',
      label: 'Date consensus time reduction',
      description: 'Group Availability Finder',
      format: 'time',
    },
    {
      id: 'dietary-flag-pct',
      label: '% of restaurants flagged correctly',
      description: 'Dietary Restriction Enforcement',
      format: 'percent',
    },
    {
      id: 'accessibility-usage',
      label: 'Usage rate (users needing accessibility)',
      description: 'Accessibility Filters',
      format: 'percent',
    },
    {
      id: 'transport-usage-pct',
      label: '% of trips using car assignments',
...
export const PHASE3_PREMIUM: MetricSection = {
  ...
  metrics: [
    {
      id: 'email-parsing-accuracy',
      label: 'Parsing accuracy',
      description: 'Email Auto-Parsing',
      format: 'percent',
    },
    {
      id: 'email-time-saved',
    ...
    {
      id: 'auto-booking-success',
      label: 'Booking success rate',
      description: 'Automated Booking',
      format: 'percent',
    },
    {
      id: 'auto-booking-errors',
      label: 'Booking error rate',
      description: 'Automated Booking',
      format: 'percent',
    },
    {
      id: 'multi-currency-pct',
      label: '% of international trips using feature',
      description: 'Multi-Currency Support',
      format: 'percent',
    },
    {
      id: 'pref-learning-improvement',
      label: 'Recommendation improvement over time',
      description: 'Preference Learning',
      format: 'percent',
    },
    { id: 'docs-per-trip', label: 'Documents uploaded per trip', description: 'Document Storage' },
    {
      id: 'conv-planning-pct',
      label: '% preferring chat vs. structured',
...
export const PHASE4_PLATFORM: MetricSection = {
  ...
  metrics: [
    {
      id: 'trips-managed-simultaneous',
      label: 'Trips managed simultaneously',
      description: 'Multi-Trip Management',
    },
    {
      id: 'concierge-usage',
      label: 'Concierge usage rate',
      description: 'Concierge Service',
      format: 'percent',
    },
    {
      id: 'concierge-satisfaction',
      label: 'Concierge satisfaction',
      description: 'Concierge Service',
      format: 'percent',
    },
    {
      id: 'discount-utilization',
      label: 'Discount utilization',
      description: 'Group Discounts',
      format: 'percent',
    },
    {
      id: 'discount-saved',
      label: '$ saved per trip',
      description: 'Group Discounts',
      format: 'currency',
    },
    ...
    {
      id: 'carbon-view-pct',
      label: '% of users viewing carbon data',
...
export const RED_FLAGS: MetricSection = {
  ...
  metrics: [
    ...
    {
      id: 'rf-expense-settlement',
      label: 'Expense settlement rate',
      description: '<75%',
      format: 'percent',
    },
    ...
    {
      id: 'rf-budget-accuracy',
      label: 'Budget accuracy',
      description: '>15% variance',
      format: 'percent',
    },
    {
      id: 'rf-ai-gen-time',
...
export const NORTH_STAR: MetricSection = {
  ...
  description:
    'Completed Trips = f(Trip Creators × Invite Acceptance × Itinerary Acceptance × Booking Completion × Trip Follow-Through × Settlement)',
  metrics: [
    { id: 'ns-signups', label: 'Signups', description: '100 →', defaultOn: true },
    {
      id: 'ns-trip-creators',
      label: 'Trip creators (60% activation)',
      description: '60',
      defaultOn: true,
    },
    { id: 'ns-invites-sent', label: 'Invites sent', description: '240 (4 per creator)' },
    {
      id: 'ns-invites-accepted',
      label: 'Invites accepted',
      description: '144 (60% acceptance)',
      defaultOn: true,
    },
    {
      id: 'ns-itineraries-generated',
      label: 'Itineraries generated',
      description: '50 (83% of creators)',
    },
