      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-2 mb-4">
            <Link href="/">
              <a className="text-blue-600 hover:text-blue-700 text-sm">← Back to Home</a>
            </Link>
          </div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Help Center</h1>
          <p className="text-lg text-gray-600">Find answers to common questions about TripSync</p>
        </div>
      </div>
            ...
            {faqCategories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <h3 className="font-semibold text-gray-900 text-left">{category.title}</h3>
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="max-w-4xl mx-auto">
          {filteredCategories.map((category) => {
            ...
            const shouldShow = !activeCategory || activeCategory === category.id || searchQuery;
        ...
        <div className="container mx-auto px-4 py-12">
          <Card className="max-w-2xl mx-auto">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-sm text-gray-500 mt-4">Average response time: 24 hours</p>
            </CardContent>
          </Card>
        </div>
      </div>
